...
func (s *Accounts) GetAccountNumbers(ctx context.Context, opts ...operations.Option) (*operations.GetAccountNumbersResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetAccountNumbersServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/accounts/accountNumbers")
	if err != nil {
	...
	res := &operations.GetAccountNumbersResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []components.AccountNumberHash
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AccountNumberHashes = out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Accounts) GetAccounts(ctx context.Context, fields *string, opts ...operations.Option) (*operations.GetAccountsResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetAccountsServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
...
func (s *Accounts) GetAccount(ctx context.Context, accountNumber string, fields *string, opts ...operations.Option) (*operations.GetAccountResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetAccountServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := utils.GenerateURL(ctx, baseURL, "/accounts/{accountNumber}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
