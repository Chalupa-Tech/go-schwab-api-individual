...
func (s *Transactions) GetTransactionsByPathParam(ctx context.Context, request operations.GetTransactionsByPathParamRequest, opts ...operations.Option) (*operations.GetTransactionsByPathParamResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetTransactionsByPathParamServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := utils.GenerateURL(ctx, baseURL, "/accounts/{accountNumber}/transactions", request, nil)
	if err != nil {
	...
	res := &operations.GetTransactionsByPathParamResponse{
...
func (s *Transactions) GetTransactionsByID(ctx context.Context, accountNumber string, transactionID int64, opts ...operations.Option) (*operations.GetTransactionsByIDResponse, error) {
	request := operations.GetTransactionsByIDRequest{
	...
	baseURL := utils.ReplaceParameters(operations.GetTransactionsByIDServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := utils.GenerateURL(ctx, baseURL, "/accounts/{accountNumber}/transactions/{transactionId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
