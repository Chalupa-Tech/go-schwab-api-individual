...
func newUserPreference(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *UserPreference {
...
func (s *UserPreference) GetUserPreference(ctx context.Context, opts ...operations.Option) (*operations.GetUserPreferenceResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetUserPreferenceServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/userPreference")
	if err != nil {
	...
	res := &operations.GetUserPreferenceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []components.UserPreference
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UserPreferences = out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
