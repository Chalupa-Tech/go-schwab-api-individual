...
// OptionChains - Get Option Chains Web Service.
...
func newOptionChains(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OptionChains {
	return &OptionChains{
		rootSDK:          rootSDK,
...
func (s *OptionChains) GetChain(ctx context.Context, request operations.GetChainRequest, opts ...operations.Option) (*operations.GetChainResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetChainServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/chains")
	if err != nil {
	...
	res := &operations.GetChainResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.OptionChain
