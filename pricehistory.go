...
// PriceHistory - Get Price History Web Service.
...
func newPriceHistory(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PriceHistory {
	return &PriceHistory{
		rootSDK:          rootSDK,
...
func (s *PriceHistory) GetPriceHistory(ctx context.Context, request operations.GetPriceHistoryRequest, opts ...operations.Option) (*operations.GetPriceHistoryResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetPriceHistoryServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/pricehistory")
	if err != nil {
	...
	res := &operations.GetPriceHistoryResponse{
